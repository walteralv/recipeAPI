...
def img_upload_url(recipe_id):
    """ Return the URL to upload image """
...
class PrivateRecipeApiTests(TestCase):
    """ Test to recipes private access """
    def setUp(self):
        self.client = APIClient()
    ...
    def test_retrieve_recipes(self):
        """ Test that retrieve a list of recipes """
    ...
    def test_recipes_limited_to_user(self):
        """ Test that the returned recipes are from the user """
    ...
    def test_filter_recipes_by_tags(self):
        """ Tost that filter recipes by tags """
    ...
    def test_filter_ingredients_by_ingredients(self):
        """ Tost that filter recipes by ingredients """
        recipe1 = sample_recipe(user=self.user, title='Thai vegetable curry')
        recipe2 = sample_recipe(user=self.user, title='Aubergine with tahini')
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_bad_request(self):
        """ Test that upload image to recipe and fail """
        url = img_upload_url(self.recipe.id)
